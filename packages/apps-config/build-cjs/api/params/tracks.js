...
exports.getGovernanceTracks = getGovernanceTracks;
var _constants = require("../constants");
// Copyright 2017-2022 @polkadot/app-config authors & contributors
// SPDX-License-Identifier: Apache-2.0

const KUSAMA = {
  fellowshipReferenda: [[[0, 'candidates'], {
    Origins: 'FellowshipInitiates'
  }], [[1, 'members'], {
    Origins: 'Fellowship1Dan'
  }], [[2, 'proficients'], {
    Origins: 'Fellowship2Dan'
  }], [[3, 'fellows'], {
    Origins: 'Fellowship3Dan'
  }], [[4, 'senior fellows'], {
    Origins: 'Fellowship4Dan'
  }], [[5, 'experts'], {
    Origins: 'Fellowship5Dan'
  }], [[6, 'senior experts'], {
    Origins: 'Fellowship6Dan'
  }], [[7, 'masters'], {
    Origins: 'Fellowship7Dan'
  }], [[8, 'senior masters'], {
    Origins: 'Fellowship8Dan'
  }], [[9, 'grand masters'], {
    Origins: 'Fellowship9Dan'
  }]],
  referenda: [[[0, 'root'], {
    system: 'Root'
...
const KNOWN_GENE_TRACKS = {
  [_constants.KUSAMA_GENESIS]: KUSAMA
};
const KNOWN_SPEC_TRACKS = {
  kusama: KUSAMA,
...
function getGovernanceTracks(api, specName, palletReferenda) {
