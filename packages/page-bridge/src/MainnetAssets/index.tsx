...
let contractAddress = "0x32a7C02e79c4ea1008dD6564b35F131428673c41";
let handler = '0x645A36124B537Ea30Cbba25F75599D3F1FE79Ba5'
...
function EthereumAssets ({ className = '', senderId: propSenderId }: Props): React.ReactElement<Props> {
  ...
  useEffect(() => {
    ...
    let contract1 = new ethers.Contract(contractAddress, abi, provider);

    contract1.getBalance(handler).then((res: any) => {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
