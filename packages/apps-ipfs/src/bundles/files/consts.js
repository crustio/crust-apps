...
export const ACTIONS = {
  ...
  /** @type {'FILES_CONTRACT_ADD'} */
  CONTRACT_ADD: ('FILES_CONTRACT_ADD'),
  /** @type {'FILES_CONTRACT_REMOVE'} */
  CONTRACT_REMOVE: ('FILES_CONTRACT_REMOVE'),
  /** @type {'FILES_CONTRACT_LIST'} */
  CONTRACT_LIST: ('FILES_CONTRACT_LIST'),
  /** @type {'FILES_SIZE_GET'} */
