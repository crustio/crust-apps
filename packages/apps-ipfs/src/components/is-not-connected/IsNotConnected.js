...
const ipfsDesktopMac = 'https://github.com/crustio/crust-apps/releases/download/v0.74.9/Crust_IPFS_Desktop.dmg';
const ipfsDesktopWin = 'https://github.com/crustio/crust-apps/releases/download/v0.74.9/Crust_IPFS_Destop_setup.exe';
const ipfsDesktopWin32 = 'https://github.com/crustio/crust-apps/releases/download/v0.74.9/Crust_IPFS_Destop_setup_win32.exe';
