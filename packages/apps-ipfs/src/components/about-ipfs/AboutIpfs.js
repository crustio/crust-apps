    ...
    <Box>
      ...
      <ul className='pl3'>
        ...
        <Trans i18nKey='aboutIpfs.paragraph3'
          t={t}>
          <li className='mb2'><strong>An on-ramp to tomorrow's web</strong> &mdash; traditional browsers can access IPFS files through gateways like <code className='f5 bg-light-gray br2 pa1'>https://ipfs.io</code> or directly using the <a className='link blue'
            href='https://github.com/ipfs-shipyard/ipfs-companion#ipfs-companion'
            rel='noopener noreferrer'
            target='_blank'>IFPS Companion</a> extension</li>
        </Trans>
        ...
        <Trans i18nKey='aboutIpfs.paragraph5'
          t={t}>
          <li className='mb2'><strong>A developer toolset</strong> for building completely <a className='link blue'
            href='https://awesome.ipfs.io/'
            rel='noopener noreferrer'
            target='_blank'>distributed apps and services</a>, backed by a robust open-source community</li>
        </Trans>
      </ul>
    </Box>
  );
