...
const ExampleRequest = ({ method = 'GET', url }) => {
  return (
...
const AnalyticType = ({ children, enabled, exampleRequest, label, onChange, queryParams, sourceLink, sourceLinkLabel = 'view source', summary }) => {
  ...
  return (
    <section className='bg-white bb b--black-10'>
      <div className='flex items-center'>
        ...
        <button className='focus-outline bg-transparent pa3 bn link blue flex-none'
...
const AnalyticsToggle = ({ analyticsActionsToRecord, analyticsConsent, analyticsEnabled, doToggleAnalytics, doToggleConsent, open, t }) => {
  return (
    <>
      ...
      <div className='f6 charcoal lh-copy'>
        ...
        <Details className='pt2'
          open={open}
          summaryText={t('AnalyticsToggle.summary')}>
          <p>
            <Trans i18nKey='AnalyticsToggle.paragraph2'
              t={t}>
              Protocol Labs hosts a <a className='link blue'
                href='https://count.ly/'>Countly</a> instance to record anonymous usage data for this app.
            </Trans>
          </p>
