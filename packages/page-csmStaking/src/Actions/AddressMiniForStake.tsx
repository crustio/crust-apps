...
function AddressMiniForStake ({ children, className = '', iconInfo, isHighlight, isPadded = true, label, totalStake, value, withAddress = true, withName = true, withShrink = false, withSidebar = true }: Props): React.ReactElement<Props> | null {
...
export default React.memo(styled(AddressMiniForStake)`
